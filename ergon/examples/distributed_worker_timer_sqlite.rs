//! Distributed worker example with timer processing (SQLite)
//!
...
//! - Work-stealing provides fair distribution even with SQLite's fast transactions!
...
//! - StealerRegistry enables workers to steal from each other when idle
//!
//! ## Performance Note
