...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    let result1 = instance1.execute(|f| Box::pin(f.clone().run_case1())).await;
    ...
    let result2 = instance2.execute(|f| Box::pin(f.clone().run_case2())).await;
    ...
    let result3 = instance3.execute(|f| Box::pin(f.clone().run_case3())).await;
    ...
    let result4 = instance4.execute(|f| Box::pin(f.clone().run_case4())).await;
    ...
    let instance5 = Executor::new(Uuid::new_v4(), Arc::clone(&test5), Arc::clone(&storage));
    let result5 = instance5.execute(|f| Box::pin(f.clone().run_case5())).await;
    ...
    let instance6 = Executor::new(Uuid::new_v4(), Arc::clone(&test6), Arc::clone(&storage));
    let result6 = instance6.execute(|f| Box::pin(f.clone().run_case6())).await;
