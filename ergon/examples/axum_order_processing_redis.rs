//! Axum + Ergon: Durable Order Processing API with Redis
//!
//! This example demonstrates how to integrate ergon with Axum using Redis as the
//! backend storage. The workflow survives server restarts and automatically resumes
//! incomplete orders.
//!
//! # Features
...
//! # Running
//! ```bash
//! cargo run --example axum_order_processing_redis --features redis
//! ```
//!
//! # Testing
//! ```bash
...
//! curl http://localhost:3001/orders/{flow_id}
//!
//! # Retry a failed order
//! curl -X POST http://localhost:3001/orders/{flow_id}/retry
//! ```
